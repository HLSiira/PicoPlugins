...
class Pagination extends AbstractPicoPlugin {
	...
	public function onPageRendering(string &$templateName, array &$twigVariables) {
		...
		if ($this->offset > 1) {
			$page_list .= "<a class=\"prev\" href=\"$prev_page_link\">Previous</a>";
		} else {
			$page_list .= "<a class=\"prev hidden\" href=\"$prev_page_link\">Previous</a>";
		}
		...
		if ($this->offset < $this->total) {
			$page_list .= "<a class=\"next\" href=\"$next_page_link\">Next</a>";
		} else {
			$page_list .= "<a class=\"next hidden\" href=\"$next_page_link\">Next</a>";
		}
